import { CloudflareWorkersAIInput } from "./llms.cjs";
import { BaseChatModelParams, LangSmithParams, SimpleChatModel } from "@langchain/core/language_models/chat_models";
 ...
 */
interface ChatCloudflareWorkersAICallOptions extends BaseLanguageModelCallOptions {}
/**
 ...
 * ```
 */
declare class ChatCloudflareWorkersAI extends SimpleChatModel implements CloudflareWorkersAIInput {
...
//#endregion
export { ChatCloudflareWorkersAI, ChatCloudflareWorkersAICallOptions };
