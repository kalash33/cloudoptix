        ...
        <div className="text-center max-w-md">
          <div className="mb-8 p-4 bg-[var(--primary)]/10 border border-[var(--primary)]/20 rounded-xl flex items-start gap-3 text-left">
            ...
            <div>
              ...
              <p className="text-sm text-[var(--primary)]/80">Kubernetes Cost Allocation is currently in development.</p>
            </div>
          </div>
  ...
  return (
    <div className="min-h-screen">
      <div className="mb-8 p-4 bg-[var(--primary)]/10 border border-[var(--primary)]/20 rounded-xl flex items-start gap-3">
        ...
        <div>
          <h3 className="font-semibold text-[var(--primary)]">Feature Coming Soon</h3>
          <p className="text-sm text-[var(--primary)]/80">Kubernetes Cost Allocation is currently in development and will be available in an upcoming release. The data below is for preview purposes.</p>
        </div>
      </div>
